...
enum NET_SDK_N9000_ALARM_TYPE
{
	...
	NET_SDK_N9000_ALARM_TYPE_TRAJECT,  ////目标跟踪轨迹

	NET_SDK_N9000_ALARM_TYPE_VEHICE,	///车牌for ipc
...
typedef struct _net_sdk_alarminfo
{
    ...
    DWORD		dwChannel;		//在报警与通道相关时，表示报警的通道号;（当报警类型为NET_SDK_ALARM_TYPE_SENSOR时，可作为pop video，>=0生效）
